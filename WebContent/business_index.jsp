...
<div class="header fixed-header">
    <div class="w">
        ...
        <div class="header-r clearfix">
            <span class="fl"><a href="login2.jsp" login="true" class="jz_lg" id='header_login'>注册登录</a></span>
        </div>
    </div>
</div>
...
<div class="b1">
    <div class="b1-inner">
        ...
        <div class="btn-group">
            <a href="post.jsp" class="index-btn pub-btn" login="true" dmbalog="/jianzhi/vip/index@atype=click@ca_source=pc@ca_from=fashpublish">快速发布职位</a>
        </div>
    </div>
</div>
